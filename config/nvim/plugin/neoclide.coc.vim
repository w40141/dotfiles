...
key('n', '[dev]d', [[<plug>(coc-definition)]], { noremap = true, silent = false })
key('n', '[dev]y', [[<plug>(coc-type-definition)]], { noremap = true, silent = false })
key('n', '[dev]i', [[<plug>(coc-implementation)]], { noremap = true, silent = false })
key('n', '[dev]r', [[<plug>(coc-references)]], { noremap = true, silent = false })
key('n', '[dev]n', [[<plug>(coc-rename)]], { noremap = true, silent = false })
