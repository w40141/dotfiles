...
function Pack:packer()
	if not self._packer then
		...
		packer.reset()
		packer.use(require("plugins.base"))
		packer.use(require("plugins.cmp"))
		packer.use(require("plugins.lsp"))
		packer.use(require("plugins.edit"))
		packer.use(require("plugins.tool"))
		packer.use(require("plugins.treesitter"))
		packer.use(require("plugins.search"))
		packer.use(require("plugins.ui"))
		packer.use(require("plugins.lang"))
		packer.use(require("plugins.misc"))
		self._packer = packer
	end
	return self._packer
end
