...
" if has('mac')
" 	let s:python3 = '/usr/local/bin/python3'
" 	let s:python2	= '/usr/local/bin/python2'
" elseif has('unix')
" " elseif system('uname') == 'Linux\n'
" 	let s:python3 = '/usr/bin/python3'
" 	let s:python2 = '/usr/bin/python2'
" endif
...
let s:toml_colors	= s:rc_dic . '/dein_colors.toml'
let s:toml_file		= s:rc_dic . '/dein_file.toml'
let s:toml_lazy		= s:rc_dic . '/dein_lazy.toml'
if dein#load_state(s:dein_dir)
	call dein#add('Shougo/dein.vim')
	call dein#begin(s:dein_dir, [s:toml, s:toml_colors, s:toml_file, s:toml_lazy])
	call dein#load_toml(s:toml,       {'lazy':0})
	call dein#load_toml(s:toml_colors,{'lazy':0})
